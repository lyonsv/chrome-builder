...
| **Quick run command** | `grep -ri "istock\|getty\|shutterstock" . --include="*.js" --include="*.html"` |
...
- **After every task commit:** Run `grep -ri "istock\|getty\|shutterstock" . --include="*.js" --include="*.html"` (TRACK-03 gate)
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 1-01-01 | 01 | 1 | INFRA-03 | automated | `grep -ri "istock\|getty\|shutterstock" . --include="*.js" --include="*.html"` | ✅ | ⬜ pending |
...
| 1-05-01 | 05 | 3 | INFRA-03 | automated | `grep -ri "istock\|getty\|shutterstock" . --include="*.js" --include="*.html"` should return 0 matches | ✅ | ⬜ pending |
